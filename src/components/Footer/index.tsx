                ...
                <li className="flex items-center mb-4">
                  ...
                  >
                    <g xmlns="http://www.w3.org/2000/svg"> 
                      <polyline fill="none" points="4 8.2 12 14.1 20 8.2" stroke="#959cb1" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2"></polyline> 
                      <rect fill="none" height="14" rx="2" ry="2" stroke="#959cb1" stroke-linecap="round" stroke-linejoin="round" strokeWidth="2" width="18" x="3" y="6.5"></rect> 
                    </g>
                  </svg>
              ...
              <div className="my-12 lg:my-16 w-full lg:w-3/4">
                ...
                <ul>
                  ...
                  <li className="flex items-center mb-4">
                    ...
                    >
                      <g xmlns="http://www.w3.org/2000/svg"> 
                        <polyline fill="none" points="4 8.2 12 14.1 20 8.2" stroke="#959cb1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polyline> 
                        <rect fill="none" height="14" rx="2" ry="2" stroke="#959cb1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="18" x="3" y="6.5"></rect> 
                      </g>
                    </svg>
                    <p className="text-base text-body-color dark:text-body-color-dark">
                      Email:{" "}
