...
const MemberHeader = ({ sticky }) => {
  ...
  const navItems = [
    ...
    { href: "/member/news", label: "News" },
    { href: "/member/calendar", label: "Calendar" },
    { href: "/member/features", label: "Features", isDropdown: true , dropdownItems: [
      { href: "/member/features/pfa-distributer", label: "PFA Distributer" },
      { href: "/member/features/ensias-map", label: "ENSIAS Map" }
    ] }
  ];
    ...
    >
      <div className="container">
        <div className="relative flex items-center justify-between w-full">
          ...
          <nav
            className={`absolute right-4 top-16 py-4 bg-white dark:bg-dark rounded-md shadow-lg ${
